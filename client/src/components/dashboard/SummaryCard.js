...
const useStyles = makeStyles((theme) => ({
    ...
    paperExpense: {
        ...
        boxShadow: theme.palette.type === 'light' ? '0 3px 5px 0 #c55b67' : '2px 4px 4px 0 #382a1c'
    },
    paperIncome: {
        ...
        boxShadow: theme.palette.type === 'light' ? '0 3px 5px 0 #6eab7191' : '2px 4px 4px 0 #382a1c'
    },
    paperBalance: {
        ...
        marginTop: '-3px',
        borderRadius: '5px',
        boxShadow: theme.palette.type === 'light' ? '0 3px 5px 0 #ffbd5abf' : '2px 4px 4px 0 #382a1c'
    },
    arrow: {
    ...
    balance: {
        marginTop: theme.spacing(1),
        padding: '8px 5px',
        // boxShadow: '0 6px 10px 0px #ffdaa2'
    },
    monthHeader: {
        color: '#cccccc',
        margin: '4px auto',
...
export default function SummaryCard(props) {
    ...
    // const [hasData, setHasData] = useState(data.length ? true : false);
