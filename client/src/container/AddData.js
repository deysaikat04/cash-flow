...
export default function AddData(props) {
  ...
  const { userid, month, theme } = props;
  ...
  const [multipleAmountErr, setMultipleAmountErr] = useState({
    multiple: false,
  });
  ...
  const handleSubmit = (e) => {
    ...
    if (!amount == "" && !category == "") {
      ...
      dispatch(addTransactions(userid, data));
    } else {
      amount === ""
        ? setError({
            ...error,
      ...
      style={{
        background:
          transactionType === "Income"
            ? theme
              ? "linear-gradient( #dcedc8 60%, #fafafa)"
              : "linear-gradient(#4f6f2938 60%, #303030)"
            : theme
            ? "linear-gradient( #ffdcdc 60%, #fafafa)"
            : "linear-gradient(#ef53501f 60%, #303030)",
              ...
              <Fragment>
                ...
                <Grid item xs={12} md={12} sm={12}>
                  <Chip
                    ...
                    style={{
                      backgroundColor:
                        transactionMode === "Cash" ? "#f9aa33" : null,
                      marginRight: "8px",
                      padding: "10px",
                    }}
                  />
                  <Chip
                    ...
                    style={{
                      backgroundColor:
                        transactionMode === "Card" ? "#f9aa33" : null,
                      marginRight: "16px",
                      padding: "10px",
                    }}
                    size="small"
                  ...
                  <Chip
                    ...
                    style={{
                      backgroundColor:
                        transactionMode === "UPI" ? "#f9aa33" : null,
                      marginRight: "16px",
                      padding: "10px",
                    }}
                    size="small"
              ...
              <form className={classes.form} onSubmit={handleSubmit}>
                ...
                {multiple && transactionType === "Expense" ? (
                  <TextField
                    ...
                    {...(multipleAmountErr.multiple && {
                      multipleAmountErr: true,
                      helperText: "Please input only numbers.",
                    })}
                  />
                ) : (
                  <></>
                ...
                <TextField
                  ...
                  helperText={
                    voicePressed
                      ? "Listening..."
                      : "Click on audio icon for voice input."
                  }
                />
                <FormControl variant="outlined" className={classes.formControl}>
                  <InputLabel htmlFor="outlined-category" color="secondary">
                    Category*
                  </InputLabel>
                  <Select
                    open={open}
